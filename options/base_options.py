...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--modality_encoder', help='Architecture of t Si Resnet50, pretrained = True par défaut', type=str, required=False, default='DRITPP', choices=['DRITPP', 'ResNet50'])
    ...
    def print_and_save(self, opt):
        ...
        if opt.use_segmentation_network:
            ...
            if self.isTrain == True and opt.lambda_segmentation_loss ==0:
